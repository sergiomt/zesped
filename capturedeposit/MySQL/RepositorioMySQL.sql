-- Creation script for ATRIL; repository  in MySQL
-- script created on Thu Jan 22 12:21:47 2009
-- Repository database version 1.2


-- ****************************************************************************
-- Security Manager System tables
-- ***************************************************************************
...
-- ****************************************************************************
-- Document Manager System tables
-- ****************************************************************************
...
-- Crear tipo Root y documento Root
...
-- Dar permisos al documento Root, al grupo de administradores
...
-- Internacionalizacion de atributos administrativos
...
-- inserciones en tipodocumento locale
...
INSERT INTO  Documento  ( IdDoc , fkIdTipoDoc , fkIdLote , fkIdDocPadre , NumSecuencia , NumIdentificador , Codigo , EspacioLibre , Version , Prioridad , TCreado , TModificado , ModificacionAdministrativa , TEliminado , fkIdSesionElimina , fkIdCola , fkIdSoporte , fkIdUltimoFichero , Clave , Completo , Bloqueado , CadenaDatosTemporales , TUltimoAcceso , NumAccesos , Mensaje , Restricciones ) VALUES (10,3,NULL,2,0,NULL,NULL,NULL,1,127,320160871,320160871,0,NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,NULL,NULL,0,'document created by the instalation script','111111111');

-- inserciones en la tabla sesion
INSERT INTO Sesion (idSesion,Usuario,Codigo,TInicio,TFin,Modo) VALUES (1, 'admin', '', 0, 0, 0);

-- inserciones en valorcadena
...
INSERT INTO  ValorCadena  ( fkIdDoc , fkIdAtributo , Version , Valor , RestoValor , TOperacion , fkIdSesion ) VALUES (10,1,1,'WorkflowDesigner','',320160871,1);
INSERT INTO  ValorCadena  ( fkIdDoc , fkIdAtributo , Version , Valor , RestoValor , TOperacion , fkIdSesion ) VALUES (10,2,1,'Workflow Designer','',320160871,1);
INSERT INTO  ValorCadena  ( fkIdDoc , fkIdAtributo , Version , Valor , RestoValor , TOperacion , fkIdSesion ) VALUES (10,3,1,'url','',320160871,1);
INSERT INTO  ValorCadena  ( fkIdDoc , fkIdAtributo , Version , Valor , RestoValor , TOperacion , fkIdSesion ) VALUES (10,4,1,'icon','',320160871,1);
